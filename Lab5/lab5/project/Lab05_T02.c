...
int main (void)
{
	...
	ROM_ADCHardwareOversampleConfigure (ADC0_BASE, 64);	//samples the adc based on the amount declared in the last argument (sample 16 times with 4 samples per time => 64)
